...
# %%
# stationary 
#1. Augmented Dickey-Fuller Test (ADF Test) 2. KPSS test 
# KPSS can test series with determistic trend
...
# AIC BIC FPE HQIC information criteria, the smaller the better
...
df_forecast
# %%
# de-difference it as many times 
